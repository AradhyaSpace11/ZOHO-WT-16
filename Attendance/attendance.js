...
const attendanceChart = new Chart(ctx, {
    ...
    data: {
        labels: lastTenDays,
        datasets: Object.entries(attendanceData).map(([division, data]) => ({
            label: division,
            data: data,
            borderColor: divisionColors[division].border,
            backgroundColor: divisionColors[division].background,
            tension: 0.4,
            borderWidth: 3,
            pointRadius: 4,
            pointHoverRadius: 6,
            fill: true,
            pointBackgroundColor: divisionColors[division].border,
    ...
    options: {
        ...
        plugins: {
            title: {
                display: true,
                text: 'Last 10 Days Attendance Trends',
                font: {
                    size: 18,
                    weight: 'bold'
                },
